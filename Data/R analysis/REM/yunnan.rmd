...
```{r}
nomination.events <- read.csv2('yunnan_eventlist_nomination.csv', sep=',')
...
```{r}
nomination.events.cond.referee <- read.csv2('yunnan_eventlist_nomination_cond_referee.csv', sep=',')
