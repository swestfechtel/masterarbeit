...
nomination.events.rem <- coxph(nomination.events.surv ~ num_referrals + partial_repetition_1 + unordered_partial_repetition_0 + unordered_partial_repetition_1 + exact_reciprocation + referee_indegree + referral_outdegree + cyclical_tie + triangle_effect_children + referee_age + referrals_avg_age + referee_referrals_age_difference + referrals_age_difference + referee_gender + referrals_avg_gender + referee_referrals_gender_difference + referee_medical + referrals_avg_medical + referee_referrals_medical_difference + referee_isco08_label + referrals_avg_isco08_label + referee_referrals_isco08_label_difference + strata(EVENT_INTERVAL), data=nomination.events)
# exact_repetition, unordered repetition, partial repetition 2-10, unordered partial repetition 2-10, transitive_tie, triangle_effect_parents NAN
...
nomination.events.cond.referee.rem <- coxph(nomination.events.cond.referee.surv ~ num_referrals + partial_repetition_1 + exact_reciprocation + referee_indegree + referral_outdegree + cyclical_tie + triangle_effect_children + referee_age + referrals_avg_age + referee_referrals_age_difference + referrals_age_difference + referee_gender + referrals_avg_gender + referee_referrals_gender_difference + referee_medical + referrals_avg_medical + referee_referrals_medical_difference + referee_isco08_label + referrals_avg_isco08_label + referee_referrals_isco08_label_difference + strata(EVENT_INTERVAL), data=nomination.events.cond.referee)
# exact repetition, unordered repetition, partial repetition 2-10, unordered partial repetition 0-10, transitive_tie, cyclical_tie, triangle_effect_parents NAN
...
nomination.events.cond.referral.rem <- coxph(nomination.events.cond.referral.surv ~ num_referrals + partial_repetition_1 + unordered_partial_repetition_0 + exact_reciprocation + referee_indegree + referral_outdegree + cyclical_tie + triangle_effect_children + referee_age + referrals_avg_age + referee_referrals_age_difference + referrals_age_difference + referee_gender + referrals_avg_gender + referee_referrals_gender_difference + referee_medical + referrals_avg_medical + referee_referrals_medical_difference + referee_isco08_label + referrals_avg_isco08_label + referee_referrals_isco08_label_difference + strata(EVENT_INTERVAL), data=nomination.events.cond.referral)
