...
nomination.events.rem <- coxph(nomination.events.surv ~ num_referrals + exact_repetition + partial_repetition_0 + partial_repetition_1 + partial_repetition_2 + unordered_partial_repetition_1 + unordered_partial_repetition_2 + unordered_partial_repetition_3 + unordered_partial_repetition_4 + unordered_partial_repetition_5 + exact_reciprocation + referee_indegree + referral_outdegree + transitive_tie + cyclical_tie + triangle_effect_children + triangle_effect_parents + referee_age + referrals_avg_age + referee_referrals_age_difference + referrals_age_difference + referee_gender + referrals_avg_gender + referee_referrals_gender_difference + referrals_gender_difference + referee_relatives + referrals_avg_relatives + referee_referrals_relatives_difference + referrals_relatives_difference + strata(EVENT_INTERVAL), data=nomination.events)
# unordered repetition, unordered partial repetition 6-10, partial repetition 3-10 NAN
```
...
```
```{r}
write.csv(tidy(nomination.events.rem), file='../../../Thesis/tables/yunnan_rhem.csv')
```
...
nomination.events.cond.referee.rem <- coxph(nomination.events.cond.referee.surv ~ num_referrals + unordered_partial_repetition_1 + unordered_partial_repetition_2 + unordered_partial_repetition_3 + unordered_partial_repetition_4 + unordered_partial_repetition_5 + referral_outdegree + referee_age + referrals_avg_age + referee_referrals_age_difference + referrals_age_difference + referee_gender + referrals_avg_gender + referee_referrals_gender_difference + referrals_gender_difference + referee_relatives + referrals_avg_relatives + referee_referrals_relatives_difference + referrals_relatives_difference + strata(EVENT_INTERVAL), data=nomination.events.cond.referee)
# unordered repetition, partial repetition 6-10, unordered partial repetition 3-10, exact_reciprocation, referee_indegree, transitive_tie, cyclical_tie, triangle_effect_children, triangle_effect_parents NAN
```
...
```
```{r}
write.csv(tidy(nomination.events.cond.referee.rem), file='../../../Thesis/tables/yunnan_rhem_cond_sender.csv')
```
...
nomination.events.cond.referral.rem <- coxph(nomination.events.cond.referral.surv ~ num_referrals + exact_repetition + partial_repetition_0 + partial_repetition_1 + partial_repetition_2 + partial_repetition_3 + partial_repetition_4 + partial_repetition_5 + unordered_partial_repetition_1 + unordered_partial_repetition_2 + unordered_partial_repetition_3 + unordered_partial_repetition_4 + unordered_partial_repetition_5 + exact_reciprocation + referee_indegree + referral_outdegree + transitive_tie + cyclical_tie + triangle_effect_children + triangle_effect_parents + referee_age + referrals_avg_age + referee_referrals_age_difference + referrals_age_difference + referee_gender + referrals_avg_gender + referee_referrals_gender_difference + referrals_gender_difference + referee_relatives + referrals_avg_relatives + referee_referrals_relatives_difference + referrals_relatives_difference + strata(EVENT_INTERVAL), data=nomination.events.cond.referral)
# unordered repetition, partial repetition 6-10, unordered partial repetition 6-10,  NAN
```
...
```
```{r}
write.csv(tidy(nomination.events.cond.referral.rem), file='../../../Thesis/tables/yunnan_rhem_cond_receiver.csv')
```
