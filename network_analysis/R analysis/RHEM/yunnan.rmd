...
```{r}
nomination.events <- read.csv('yunnan_eventlist_nomination.csv', sep=',')
...
nomination.events.rem <- coxph(nomination.events.surv ~ num_referrals + exact_repetition + partial_repetition_1 + partial_repetition_2 + partial_repetition_3 + partial_repetition_4 + partial_repetition_5 + unordered_partial_repetition_0 + unordered_partial_repetition_1 + exact_reciprocation + referee_indegree + referral_outdegree + transitive_tie + cyclical_tie + triangle_effect_children + triangle_effect_parents + referee_age + referrals_avg_age + referee_referrals_age_difference + referrals_age_difference + referee_gender + referrals_avg_gender + referee_referrals_gender_difference + referee_relatives + referrals_avg_relatives + referee_referrals_relatives_difference + strata(EVENT_INTERVAL), data=nomination.events)
# unordered repetition, partial repetition 6-10, unordered partial repetition 2-10 NAN
summary(nomination.events.rem)
```


```{r}
nomination.events.cond.referee <- read.csv('yunnan_eventlist_nomination_cond_referee.csv', sep=',')
...
nomination.events.cond.referee.rem <- coxph(nomination.events.cond.referee.surv ~ num_referrals + partial_repetition_1 + partial_repetition_2 + partial_repetition_3 + partial_repetition_4 + partial_repetition_5 + referral_outdegree + referee_age + referrals_avg_age + referee_referrals_age_difference + referrals_age_difference + referee_gender + referrals_avg_gender + referee_referrals_gender_difference + referee_relatives + referrals_avg_relatives + referee_referrals_relatives_difference + strata(EVENT_INTERVAL), data=nomination.events.cond.referee)
# exact repetition, unordered repetition, partial repetition 6-10, unordered partial repetition 0-10, exact_reciprocation, referee_indegree, transitive_tie, cyclical_tie, triangle_effect_children, triangle_effect_parents NAN
summary(nomination.events.cond.referee.rem)
```

```{r}
nomination.events.cond.referral <- read.csv('yunnan_eventlist_nomination_cond_referral.csv', sep=',')
...
nomination.events.cond.referral.rem <- coxph(nomination.events.cond.referral.surv ~ num_referrals + exact_repetition + partial_repetition_1 + partial_repetition_2 + partial_repetition_3 + partial_repetition_4 + partial_repetition_5 + unordered_partial_repetition_0 + unordered_partial_repetition_1 + unordered_partial_repetition_2 + unordered_partial_repetition_3 + unordered_partial_repetition_4 + unordered_partial_repetition_5 + exact_reciprocation + referee_indegree + referral_outdegree + transitive_tie + cyclical_tie + triangle_effect_children + triangle_effect_parents + referee_age + referrals_avg_age + referee_referrals_age_difference + referrals_age_difference + referee_gender + referrals_avg_gender + referee_referrals_gender_difference + referee_relatives + referrals_avg_relatives + referee_referrals_relatives_difference + strata(EVENT_INTERVAL), data=nomination.events.cond.referral)
# unordered repetition, partial repetition 6-10, unordered partial repetition 6-10, exact_reciprocation, referee_indegree, transitive_tie, cyclical_tie, triangle_effect_children, triangle_effect_parents NAN
