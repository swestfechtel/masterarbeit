...
```
```{r}
write.csv(tidy(nomination.events.rem), file='../../../Thesis/tables/hainan_rem.csv')
```
```{r}
...
```
```{r}
write.csv(tidy(nomination.events.cond.referee.rem), file='../../../Thesis/tables/hainan_rem_cond_sender.csv')
```
...
```
```{r}
write.csv(tidy(nomination.events.cond.referral.rem), file='../../../Thesis/tables/hainan_rem_cond_receiver.csv')
```
